	...
	<div class="row justify-content-center">
		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					<td><a href="{{ route('agente.viewaposta', ['aposta'=>$aposta->id]) }}">{{ $aposta->id }}</a></td>
					<td>{{ $aposta->nome }}</td>
					<td>R$ {{ $aposta->valor_apostado }}</td>
	...
	<div class="row justify-content-center">
		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					<td><a href="{{ route('agente.bolao.apostas', ['bolao_id'=>$bolao->id]) }}">{{ $bolao->id }}</a></td>
					<td>{{ $bolao->nome }}</td>
